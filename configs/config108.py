...
# 疑似识别阈值 (低于确认阈值但高于此值时显示"疑似")
# Suspicious threshold (show as "suspected" when between this and main threshold)
...
# RTSP 流路径 (根据摄像头型号可能需要调整，常见: /stream1, /h264, /Streaming/Channels/1)admin
# RTSP stream path (may need adjustment based on camera model)
RTSP_STREAM_PATH = "/livestream/12"
#RTSP_STREAM_PATH = "/0-0"

# 完整的 RTSP URL (自动生成)
# Full RTSP URL (auto-generated)
RTSP_URL = f"rtsp://{RTSP_HOST}:{RTSP_PORT}{RTSP_STREAM_PATH}"
